...
class Example(QMainWindow,QWidget):
        ...
        def main(self):
            ...
            Quickschedule= QAction(QIcon("Z.png"),"&Quick Schedule",self)
            Quickschedule.setStatusTip("Have a quick schedule")
            
            Quickschedule.triggered.connect(self.enable)
            ...
            Homemenu.addAction(Quickschedule)
            ...
            shirtbutton= QPushButton("Tops",self)
            shirtbutton.setIcon(QIcon("tops.png"))
            #shirtbutton.setIconSize(QSize(24,24))
            shirtbutton.clicked.connect(self.newwin)
            shirtbutton.move(50,50)
            
            downbutton= QPushButton("Down",self)
            downbutton.setIcon(QIcon("down.png"))
            downbutton.setIconSize(QSize(24,24))
            downbutton.clicked.connect(self.newwin1)
            downbutton.move(750,450)
            GETbutton= QPushButton("GET",self) 
            GETbutton.clicked.connect(self.scheduling)
            GETbutton.move(500,200)
